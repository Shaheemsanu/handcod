...
class AppDropdownForm<T> extends FormBuilderFieldDecoration<T> {
  ...
  @override
  FormBuilderFieldDecorationState<AppDropdownForm<T>, T> createState() =>
      _FormBuilderDropdownState<T>();
}

class _FormBuilderDropdownState<T>
    extends FormBuilderFieldDecorationState<AppDropdownForm<T>, T> {
  @override
  void didUpdateWidget(covariant AppDropdownForm<T> oldWidget) {
