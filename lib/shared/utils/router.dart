import 'package:handcode_test/features/auth/presentation/auth/auth.dart';
import 'package:handcode_test/features/cart/cart.dart';
import 'package:handcode_test/features/home/home.dart';
import 'package:handcode_test/features/service/presentation/service/service.dart';
...
class AppRouter {
  ...
  late final GoRouter router = GoRouter(
    ...
    redirect: (context, state) async {
      ...
      final isAuth = storage.getBool("isLogin") ?? false;
